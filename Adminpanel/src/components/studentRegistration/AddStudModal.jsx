...
const AddStudModal = ({ showModal, handleClose ,fetchList}) => {
    ...
    if (validateForm()) {
      fetch("http://localhost:4040/api/students/admission", {
        ...
        .then((data) => {
          ...
          // alert("Student ID is ",studentId);
          toast.success("Form submitted successfully!!! Student ID is: "+  studentId,  {
...
<div className="div-flex-column">
            <div><button type="submit" variant="secondary" id="modalSubmit">Register</button></div>
